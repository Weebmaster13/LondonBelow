...
Certification covers runtime node, dependency, capability, requirement, compatibility, ordering, startup plan, shutdown plan, group, graph validation record, validation failure, snapshot, plan node, group node, plan dependency, and plan ordering limits.
