...
Filters are schema constraints, not live filtering. They reject filter execution, payload inspection execution, callback, listener, and payload delivery markers. Future live filtering must be a separate governed execution system.
