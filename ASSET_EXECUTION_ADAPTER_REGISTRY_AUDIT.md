...
Audit validation now explicitly protects exact audit fields, exact audit enums, duplicate audit ids, duplicate child references, unordered child references, missing boundary references, missing compatibility references, cross-registration child references, unsafe evidence, unsafe tags, unsafe metadata, and failed-validation no mutation.
