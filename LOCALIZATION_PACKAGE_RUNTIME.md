...
Packages must not be treated as translation files. Future package loading, localization export, and translation import systems must be separate governed systems.
