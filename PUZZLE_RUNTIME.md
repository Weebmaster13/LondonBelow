...
The graph validator rejects duplicate nodes, missing dependencies, completion nodes that do not exist, and dependency cycles. Wrong inputs and missing dependency attempts are recorded without creating one-off puzzle scripts.
