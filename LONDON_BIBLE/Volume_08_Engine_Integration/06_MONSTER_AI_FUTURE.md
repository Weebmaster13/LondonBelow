...
Monster AI is not implemented by this Bible.
...
Monster AI does not own horror pacing. It owns execution of approved movement, perception, animation state, and physical threat behavior once future phases begin.

## Open Design Questions

- What observations should trigger reveal requests?
- What does the entity learn about hiding spots?
- When should choosing not to chase be scarier than chasing?
