...
local builtInContracts: { EngineContract } = {
	...
	},
	{
		...
		responsibilities = {
			...
			"reject lifecycle, module loading, require, dependency injection, service resolution, Framework replacement, runtime call, orchestration, execution, service, remote, client, content, analytics, telemetry, Workspace, and Chapter fields",
		...
		multiplayerGuarantees = {
			...
			"clients cannot define graph schemas, resolve services, trigger lifecycle behavior, replace Framework, or own dependency truth through this runtime",
		},
		failureModes = {
			...
			"unsafe payloads reject",
			"forbidden lifecycle, module loading, require, dependency injection, service resolution, Framework replacement, runtime call, orchestration, execution, service reference, adapter reference, handler reference, callback, workspace path, remote, client, content, analytics, telemetry, Chapter, story, dialogue, and cutscene fields reject",
			"serialization rejects Roblox Instances, cycles, functions, threads, userdata, oversized strings, deep payloads, and oversized node counts",
