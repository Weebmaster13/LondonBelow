...
local builtInContracts: { EngineContract } = {
	...
	},
	{
		...
		responsibilities = {
			...
			"reject final content, loading, streaming, spawning, execution, service, remote, client, save, analytics, telemetry, Workspace, and Chapter fields",
			"own Content Registry diagnostics, snapshots, serialization, validation, and self-checks",
			"provide future content structure without loading, streaming, spawning, rendering, persistence, remotes, client authority, or Chapter content",
		},
		doesNotOwn = {
			"Chapter content",
			"Chapter 0 content",
		...
		executionPermissions = {
			"schema records only",
			"no content, asset, map, room, streaming, spawning, gameplay, puzzle, interaction, inventory, objective, narrative, save, DataStore, HTTP, messaging, remote, client, analytics, telemetry, Workspace, or Chapter execution",
		},
		clientPresentation = {
			allowed = false,
		...
		multiplayerGuarantees = {
			...
			"forbidden final content, loading, streaming, spawning, execution, service, remote, client, save, analytics, telemetry, Workspace, and Chapter fields reject before state changes",
			"clients cannot define content schemas, load content, stream content, spawn content, or own content truth through this runtime",
		},
		failureModes = {
