...
local RuntimeCapabilityCoordinator = require(script.Parent.Capabilities.CapabilityCoordinator)
local RuntimeDomainCapabilityCoordinator =
	require(script.Parent.DomainCapabilities.DomainCapabilityCoordinator)
...
local DialogueCoordinator = require(script.Parent.Parent.Dialogue.Core.DialogueCoordinator)
local DialogueExecutionCoordinator =
...
local Chapter196VerticalSliceCoordinator =
	require(script.Parent.Parent.Gameplay.VerticalSlice.Chapter196Coordinator)
...
local PresentationRuntimeCoordinator =
	require(script.Parent.Parent.Presentation.Core.PresentationRuntimeCoordinator)
local PresentationExecutionCoordinator =
	require(script.Parent.Parent.Presentation.Core.PresentationExecutionCoordinator)
local PresentationRenderingCoordinator =
...
local RobloxRenderingSessionCoordinator =
...
local RobloxGuiInstanceContractCoordinator =
	require(script.Parent.Parent.Presentation.Core.RobloxGuiInstanceContractCoordinator)
...
local function startEngine()
	...
	Framework.registerModule("RuntimeQueryBusCoordinator", RuntimeQueryBusCoordinator, {
		"Logger",
		"Diagnostics",
		"SnapshotManager",
		"RuntimeEventBusCoordinator",
	...
	Framework.registerModule("RuntimeMessagingCoordinator", RuntimeMessagingCoordinator, {
		"Logger",
		"Diagnostics",
		"SnapshotManager",
		"RuntimeEventBusCoordinator",
	...
	Framework.registerModule("RuntimeCapabilityCoordinator", RuntimeCapabilityCoordinator, {
		"Logger",
		"Diagnostics",
		"SnapshotManager",
		"RuntimeEventBusCoordinator",
	...
	Framework.registerModule("DialogueCoordinator", DialogueCoordinator, {
		"Logger",
		"Diagnostics",
		"SnapshotManager",
		"RuntimeEventBusCoordinator",
	...
	Framework.registerModule("DialogueExecutionCoordinator", DialogueExecutionCoordinator, {
		"Logger",
		"Diagnostics",
		"SnapshotManager",
		"RuntimeEventBusCoordinator",
	...
	Framework.registerModule("DialogueInteractionCoordinator", DialogueInteractionCoordinator, {
		"Logger",
		"Diagnostics",
		"SnapshotManager",
		"RuntimeEventBusCoordinator",
	...
	Framework.registerModule("PresentationRuntimeCoordinator", PresentationRuntimeCoordinator, {
		"Logger",
		"Diagnostics",
		"SnapshotManager",
		"RuntimeEventBusCoordinator",
	...
	Framework.registerModule("PresentationExecutionCoordinator", PresentationExecutionCoordinator, {
		"Logger",
		"Diagnostics",
		"SnapshotManager",
		"RuntimeEventBusCoordinator",
	...
	Framework.registerModule("PresentationRenderingCoordinator", PresentationRenderingCoordinator, {
		"Logger",
		"Diagnostics",
		"SnapshotManager",
		"RuntimeEventBusCoordinator",
	...
	Framework.registerModule(
		"RobloxGuiInstanceContractCoordinator",
		RobloxGuiInstanceContractCoordinator,
		{
			"Logger",
			"Diagnostics",
	...
	Framework.registerModule(
		"Chapter196VerticalSliceCoordinator",
		Chapter196VerticalSliceCoordinator,
		{
			"Logger",
			"EventBus",
