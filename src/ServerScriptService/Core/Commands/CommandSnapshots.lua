...
function Snapshots.capture(runtime: any)
	return Serialization.deepCopy({
		...
		certificationSnapshot = runtime.getObservabilitySnapshot().certification,
		resourceBudgetsSnapshot = runtime.getObservabilitySnapshot().resourceBudgets,
		performanceBudgetsSnapshot = runtime.getObservabilitySnapshot().performanceBudgets,
		compatibilitySnapshot = runtime.getObservabilitySnapshot().compatibility,
		migrationSnapshot = runtime.getObservabilitySnapshot().migration,
		auditSnapshot = runtime.getObservabilitySnapshot().audits,
		stressValidationSnapshot = runtime.getObservabilitySnapshot().stressValidation,
		faultInjectionSnapshot = runtime.getObservabilitySnapshot().faultInjection,
		integritySnapshot = runtime.getObservabilitySnapshot().integrity,
		productionReviewSnapshot = runtime.getObservabilitySnapshot().productionReview,
