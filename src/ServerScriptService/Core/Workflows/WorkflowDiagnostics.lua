...
function Diagnostics.capture(runtime: any)
	return {
		...
		workflowIntegration = runtime.getIntegration(),
		workflowIntegrationPosture = if runtime.isShutdown() then "Shutdown" else "Healthy",
		...
		noDirectCommandBusExecution = true,
		noDirectEventBusPublication = true,
		noDirectQueryBusExecution = true,
		noNetworking = true,
