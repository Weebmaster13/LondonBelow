...
function Diagnostics.capture(lifecycle: any, dependencies: any)
	...
	return Serialization.deepCopy({
		...
		planIntegrityPosture = {
			descriptionsOnly = true,
			notCommands = true,
			notDispatchers = true,
		},
		slotIntegrityPosture = { schemaPositionsOnly = true, notFrameSlots = true },
		queueIntegrityPosture = { schemasOnly = true, notLiveQueues = true },
		priorityIntegrityPosture = { policyValuesOnly = true, notDispatchCommands = true },
		...
		noExecutionPosture = {
			...
			noHeartbeatLoops = true,
			noSteppedLoops = true,
			noRenderSteppedLoops = true,
			noQueueProcessing = true,
			noRetryExecution = true,
			noTimeoutExecution = true,
			noTimerExecution = true,
			noGapExecution = true,
			noDispatchExecution = true,
			noAsyncExecution = true,
			noTaskLibraryExecution = true,
			noWaitSpawnFamily = true,
