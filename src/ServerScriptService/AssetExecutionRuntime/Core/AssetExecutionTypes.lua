...
Types.AdapterContractIntegrationKind = {
	...
	AuthorizationIntegration = true,
	ExecutionRuntimeIntegration = true,
	AdapterContractIntegration = true,
	DocumentationIntegration = true,
	ValidationIntegration = true,
	SerializationIntegration = true,
	SnapshotIsolationIntegration = true,
	LifecycleIntegration = true,
	AuthorityIntegration = true,
	OperationBoundaryIntegration = true,
	FutureAdapterImplementationIntegration = true,
	FutureGameplaySeparationIntegration = true,
	ProductionCertificationIntegration = true,
}

Types.AdapterContractIntegrationStatus = {
	Declared = true,
	IntegrationReady = true,
	BoundaryConfirmed = true,
	ObservationOnly = true,
...
Types.AdapterContractIntegrationBoundary = {
	CopiedMetadataOnly = true,
	NoAdapterRuntime = true,
	NoAdapterProvider = true,
	NoAdapterRegistry = true,
	...
	FutureImplementationSeparate = true,
}
...
local ADAPTER_CONTRACT_INTEGRATION_ROWS = {
	{
		"01",
		"runtime",
		"RuntimeIntegration",
...
for _, fieldName in ipairs(Types.AdapterContractIntegrationDeclarationFields) do
	if fieldName ~= "evidence" and fieldName ~= "tags" and fieldName ~= "metadata" then
		Types.AdapterContractIntegrationDeclarationOrder[orderNameForField(fieldName)] = {}
	end
end

for _, row in ipairs(ADAPTER_CONTRACT_INTEGRATION_ROWS) do
	local order = row[1]
	local compatibility = row[2]
	local declaration = {
		...
		executionProviderName = Types.RuntimeProviderName,
		executionCoordinatorName = Types.CoordinatorName,
		adapterContractProviderName = Types.RuntimeProviderName,
		adapterContractSnapshotProviderName = Types.RuntimeProviderName,
		futureAdapterRuntimeName = "AbsentFutureAdapterRuntime",
		futureAdapterProviderName = "absentFutureAdapterProvider",
		...
		required = true,
		evidence = { "asset.execution.adapter.contract.integration." .. compatibility .. ".copied" },
	...
	table.insert(Types.AssetExecutionAdapterContractIntegrationDeclarations, declaration)
	for _, fieldName in ipairs(Types.AdapterContractIntegrationDeclarationFields) do
		if fieldName ~= "evidence" and fieldName ~= "tags" and fieldName ~= "metadata" then
			table.insert(
				Types.AdapterContractIntegrationDeclarationOrder[orderNameForField(fieldName)],
