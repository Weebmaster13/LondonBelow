...
function Snapshots.capture(lifecycle: any, dependencies: any)
	...
	local snapshot = {
		...
		assetExecutionAdapterContractIntegrationIsolationPosture = "adapter contract integration snapshots expose deep copies only",
		...
		assetExecutionAdapterContractIntegrationHardeningPosture = "adapter contract integration production hardening freezes certified declarations",
		assetExecutionAdapterContractIntegrationExactnessPosture = "adapter contract integration fields and scalar values reject drift",
		assetExecutionAdapterContractIntegrationOrderingPosture = "adapter contract integration declaration and order tables are exact",
		assetExecutionAdapterContractIntegrationIdentityPosture = "adapter contract integration identities reject aliases",
		assetExecutionAdapterContractIntegrationMetadataPosture = "adapter contract integration metadata keys and values are exact",
		assetExecutionAdapterContractIntegrationEvidencePosture = "adapter contract integration evidence arrays are exact",
		assetExecutionAdapterContractIntegrationTagPosture = "adapter contract integration tag arrays are exact",
		assetExecutionAdapterContractIntegrationLimitPosture = "adapter contract integration uses certified runtime limits only",
		assetExecutionAdapterContractIntegrationCertificationPosture = "adapter contract integration is frozen copied metadata only",
		...
		adapterContractIntegration = {
			...
			order = dependencies.Serialization.deepCopy(
				Types.AdapterContractIntegrationDeclarationOrder
			),
			fields = dependencies.Serialization.deepCopy(
