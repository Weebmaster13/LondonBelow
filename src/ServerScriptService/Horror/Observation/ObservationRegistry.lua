...
local definitions: { ObservationDefinition } = {
	...
	{
		id = "Chapter0Home.NoteAcknowledged",
		category = "Story",
		description = "Chapter 0 Home Mum note acknowledgement fact.",
		expectedMetadata = { "factId", "chapterId", "interactionId", "stageId" },
		weight = 0.7,
		priority = 35,
		aggregation = "Unique",
		expiration = "Chapter",
	...
	{
		id = "Chapter0Home.GasLampUnsteadyComfort",
		category = "Environment",
		description = "Chapter 0 Home gas lamp unstable comfort fact.",
		expectedMetadata = { "factId", "chapterId", "interactionId", "stageId" },
		weight = 0.6,
		priority = 35,
		aggregation = "Unique",
	...
	{
		id = "Chapter0Home.RibbonQuietEscalation",
		category = "Story",
		description = "Chapter 0 Home Marmalade ribbon quiet escalation fact.",
		expectedMetadata = { "factId", "chapterId", "interactionId", "stageId" },
		weight = 0.8,
		priority = 45,
		aggregation = "Unique",
	...
	{
		id = "Chapter0Home.BedroomDoorResistance",
		category = "Environment",
		description = "Chapter 0 Home optional bedroom-door resistance fact.",
		expectedMetadata = { "factId", "chapterId", "interactionId", "optionalModifier" },
		weight = 0.5,
		priority = 30,
		aggregation = "Unique",
		expiration = "Chapter",
	...
	{
		id = "Chapter0Home.CurrentAtmosphericStage",
		category = "Story",
		description = "Chapter 0 Home current atmospheric progression stage fact.",
		expectedMetadata = { "factId", "chapterId", "stageId", "sequence" },
		weight = 0.6,
		priority = 35,
		aggregation = "Latest",
		expiration = "Chapter",
	...
	{
		id = "Chapter0Home.EnvironmentalReactionPosture",
		category = "Environment",
		description = "Chapter 0 Home environmental reaction posture fact.",
		expectedMetadata = { "factId", "chapterId", "reactionId", "sequence" },
		weight = 0.4,
		priority = 25,
		aggregation = "Latest",
		expiration = "Chapter",
	...
	{
		id = "Chapter0Home.AtmosphericFeedbackPosture",
		category = "Story",
		description = "Chapter 0 Home atmospheric feedback posture fact.",
		expectedMetadata = { "factId", "chapterId", "feedbackId", "sequence" },
		weight = 0.4,
		priority = 25,
		aggregation = "Latest",
		expiration = "Chapter",
...

	{
		...
		category = "Gameplay",
		description = "Server accepted an object interaction.",
		expectedMetadata = { "objectId", "objectKind" },
		weight = 0.7,
		priority = 40,
		aggregation = "Count",
		expiration = "TenMinutes",
	},
	{
		...
		category = "Gameplay",
		description = "Server changed reusable object state.",
		expectedMetadata = { "objectId", "state" },
		weight = 0.8,
		priority = 45,
		aggregation = "Latest",
		expiration = "Chapter",
	},
	{
		id = "Door.Opened",
		category = "Gameplay",
		description = "Server opened a door.",
		expectedMetadata = { "doorId" },
		weight = 0.8,
		priority = 45,
		aggregation = "Count",
		expiration = "Chapter",
	},
	{
		id = "Door.Closed",
		category = "Gameplay",
		description = "Server closed a door.",
		expectedMetadata = { "doorId" },
		weight = 0.5,
		priority = 35,
		aggregation = "Count",
	...
	},
	{
		id = "Door.Locked",
		category = "Gameplay",
		description = "Server marked a door locked.",
		expectedMetadata = { "doorId" },
		weight = 0.7,
		priority = 45,
		aggregation = "Latest",
	...
	},
	{
		id = "Door.Unlocked",
		category = "Gameplay",
		description = "Server unlocked a door.",
		expectedMetadata = { "doorId" },
		weight = 0.9,
		priority = 50,
		aggregation = "Unique",
	...
	},
	{
		id = "Door.FailedOpen",
		category = "Gameplay",
		description = "Player failed to open a locked or unavailable door.",
		expectedMetadata = { "doorId", "reason" },
		weight = 0.9,
		priority = 45,
		aggregation = "Count",
		expiration = "TenMinutes",
	},
	{
		...
		category = "Gameplay",
		description = "Server added an item to inventory truth.",
		expectedMetadata = { "itemId", "itemKind" },
		weight = 0.8,
		priority = 45,
		aggregation = "Count",
		expiration = "Chapter",
	},
	{
		...
		category = "Gameplay",
		description = "Server removed an item from inventory truth.",
		expectedMetadata = { "itemId", "itemKind" },
		weight = 0.6,
		priority = 40,
		aggregation = "Count",
	...
	},
	{
		id = "Key.Collected",
		category = "Gameplay",
		description = "Server accepted key collection.",
		expectedMetadata = { "keyId" },
		weight = 0.9,
		priority = 50,
		aggregation = "Unique",
	...
	},
	{
		id = "Key.Used",
		category = "Gameplay",
		description = "Server accepted key use.",
		expectedMetadata = { "keyId", "targetId" },
		weight = 1.0,
		priority = 55,
		aggregation = "Count",
		expiration = "Chapter",
	...
	},
	{
		...
		category = "Gameplay",
		description = "Reusable objective started.",
		expectedMetadata = { "objectiveId" },
		weight = 0.6,
		priority = 45,
		aggregation = "Latest",
	...
	},
	{
		...
		category = "Gameplay",
		description = "Reusable objective progressed.",
		expectedMetadata = { "objectiveId", "progress" },
		weight = 0.8,
		priority = 50,
		aggregation = "Latest",
	...
	},
	{
		...
		category = "Gameplay",
		description = "Reusable objective completed.",
		expectedMetadata = { "objectiveId" },
		weight = 1.1,
		priority = 60,
		aggregation = "Unique",
	...
	},
	{
		id = "Objective.Failed",
		category = "Gameplay",
		description = "Reusable objective failed.",
		expectedMetadata = { "objectiveId", "reason" },
		weight = 0.8,
		priority = 50,
		aggregation = "Latest",
		expiration = "Chapter",
	},
	{
		id = "Puzzle.Started",
		category = "Gameplay",
		description = "Puzzle graph started.",
		expectedMetadata = { "puzzleId" },
		weight = 0.6,
		priority = 45,
		aggregation = "Latest",
	...
	},
	{
		...
		category = "Gameplay",
		description = "Puzzle graph node completed.",
		expectedMetadata = { "puzzleId", "nodeId" },
		weight = 0.9,
		priority = 50,
		aggregation = "Count",
		expiration = "Chapter",
	...
	},
	{
		...
		category = "Gameplay",
		description = "Puzzle received a wrong input.",
		expectedMetadata = { "puzzleId" },
		weight = 1.0,
		priority = 45,
		aggregation = "Count",
		expiration = "TenMinutes",
		directorKind = "PuzzleFriction",
	},
	{
		id = "Puzzle.HintRequested",
		category = "Gameplay",
		description = "Player or system requested a puzzle hint.",
		expectedMetadata = { "puzzleId" },
		weight = 0.6,
		priority = 40,
		aggregation = "Count",
	...
	},
	{
		id = "Puzzle.HintShown",
		category = "Gameplay",
		description = "Server approved a progressive puzzle hint for presentation.",
		expectedMetadata = { "puzzleId", "hintIndex" },
		weight = 0.7,
		priority = 45,
		aggregation = "Count",
		expiration = "Chapter",
	},
	{
		id = "Puzzle.Completed",
		category = "Gameplay",
		description = "Puzzle graph completed.",
		expectedMetadata = { "puzzleId" },
		weight = 1.2,
		priority = 60,
		aggregation = "Unique",
	...
	},
	{
		id = "Puzzle.Failed",
		category = "Gameplay",
		description = "Puzzle graph failed.",
		expectedMetadata = { "puzzleId", "reason" },
		weight = 0.9,
		priority = 50,
		aggregation = "Latest",
		expiration = "Chapter",
