...
Types.ContractState = table.freeze({
	Draft = "Draft",
	Validated = "Validated",
	Published = "Published",
	Rejected = "Rejected",
...
Types.PropertyMutability = table.freeze({
...
Types.ReferenceKind = table.freeze({
	Parent = "Parent",
