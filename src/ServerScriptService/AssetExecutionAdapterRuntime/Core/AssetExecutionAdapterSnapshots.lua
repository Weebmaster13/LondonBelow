...
function Snapshots.capture(lifecycle: any, dependencies: any)
	...
	local snapshot = {
		...
		assetExecutionAdapterRuntimeLimitPosture = "limit posture is immutable metadata only",
		...
		assetExecutionAdapterDiagnosticsPosture = "diagnostics identity remains health-only metadata",
		assetExecutionAdapterSnapshotPosture = "snapshots expose deterministic copied metadata",
		assetExecutionAdapterHardeningPosture = "production hardening freezes Phase 101 surfaces",
		assetExecutionAdapterIdentityHardeningPosture = "runtime identities reject aliases and casing drift",
		assetExecutionAdapterOrderingHardeningPosture = "schema and provider ordering are fixed",
		assetExecutionAdapterMetadataHardeningPosture = "metadata remains serializable and non-executable",
		assetExecutionAdapterEvidenceHardeningPosture = "evidence arrays remain ordered copied ids",
		assetExecutionAdapterTagHardeningPosture = "tag arrays remain ordered copied ids",
