...
local function posture()
	return {
		...
		assetExecutionAdapterDiagnosticsPosture = "diagnostics expose health-only copied metadata",
		assetExecutionAdapterSnapshotPosture = "snapshot identity remains deterministic metadata",
