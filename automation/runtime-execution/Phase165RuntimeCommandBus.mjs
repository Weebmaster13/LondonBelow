...
const requiredFiles = [
  ...
  "src/ServerScriptService/Core/Commands/CommandProfiler.lua",
  "src/ServerScriptService/Core/Commands/CommandMetrics.lua",
  "src/ServerScriptService/Core/Commands/CommandHealth.lua",
  "src/ServerScriptService/Core/Commands/CommandTimeline.lua",
  "src/ServerScriptService/Core/Commands/CommandInspection.lua",
  "src/ServerScriptService/Core/Commands/CommandCorrelation.lua",
  "src/ServerScriptService/Core/Commands/CommandTraceGraph.lua",
  "src/ServerScriptService/Core/Commands/CommandLatency.lua",
  "src/ServerScriptService/Core/Commands/CommandSessions.lua",
  "src/ServerScriptService/Core/Commands/CommandCertification.lua",
  "src/ServerScriptService/Core/Commands/CommandStressValidation.lua",
  "src/ServerScriptService/Core/Commands/CommandFaultInjection.lua",
  "src/ServerScriptService/Core/Commands/CommandCompatibility.lua",
  "src/ServerScriptService/Core/Commands/CommandMigration.lua",
  "src/ServerScriptService/Core/Commands/CommandResourceBudgets.lua",
  "src/ServerScriptService/Core/Commands/CommandPerformanceBudgets.lua",
  "src/ServerScriptService/Core/Commands/CommandAudits.lua",
  "src/ServerScriptService/Core/Commands/CommandIntegrity.lua",
  "src/ServerScriptService/Core/Commands/CommandProductionReview.lua",
...
function sourceChecks() {
  ...
  for (const token of [
    ...
    "CommandStressValidation",
    "CommandFaultInjection",
    "CommandCompatibility",
    "CommandMigration",
    "CommandResourceBudgets",
    "CommandPerformanceBudgets",
    "CommandAudits",
    "CommandIntegrity",
    "CommandProductionReview",
    "Immediate",
    "Deferred",
    "Scheduled",
    "Exclusive",
    ...
    "throughputHistorySnapshot",
    "runtimeHealthSnapshot",
    "pressureMetricsSnapshot",
    "executionGraphSnapshot",
    "correlationGraphSnapshot",
    "activeSessionsSnapshot",
    "inspectionViewsSnapshot",
    "certificationSnapshot",
    "resourceBudgetsSnapshot",
    "performanceBudgetsSnapshot",
    "compatibilitySnapshot",
    "migrationSnapshot",
    "auditSnapshot",
    "stressValidationSnapshot",
